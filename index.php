...
<body>
    ...
    <div class="container">
        <div class="hero" style="background-image: url('assets/images/herobackground.jpg');">
            <div class="hero-content">
                ...
                <a href="views/reservasi.php" class="btn" style="background-color: #343fdb;">Pesan Kamar Sekarang</a>
            </div>
        </div>
